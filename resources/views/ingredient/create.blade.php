...
<x-app-layout>
    ...
    <div class="container">
      ...
      <form method="POST" action="{{route('ingredients.store')}}">
          ...
          <div class="mb-3">
              <label for="name" class="form-label">Nombre Ingrediente</label>
              <input type="text" class="form-control" id="ojo" aria-describedby="nameHelp" name="nombre" placeholder="Ingredientes">
