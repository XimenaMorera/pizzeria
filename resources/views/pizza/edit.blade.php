    ...
    <div class="container">
      ...
      <form method="POST" action="{{route('pizzas.update',['pizza'=>$pizza->id])}}">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="id" aria-describedby="idHelp" name="id" disabled="disable" value="{{$pizza->id}}">
            <div id="idHelp" class="form-text">Id Pizza</div>
          </div>
          <div class="mb-3">
              <label for="name" class="form-label">Pizza</label>
              <input type="text" class="form-control" id="ojo" aria-describedby="nameHelp" name="nombre" value="{{$pizza->name}}">
